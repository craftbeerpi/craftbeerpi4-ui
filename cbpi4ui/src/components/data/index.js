...
export const CBPiProvider = ({ children }) => {
  ...
  const value = {
    state: { sensors, version, actors, logic, kettle, fermenter, fermenterlogic, auth, plugins, temp, sensorData, actorTypes, sensorTypes, config, mashProfile, mashBasic, stepTypes },
    actions: {
      delete_kettle,
      add_kettle,
      target_temp_kettle,
